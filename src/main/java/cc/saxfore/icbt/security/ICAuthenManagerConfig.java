 ...
 * 创 建 人：wangjiang
 * 类 描 述：使用{@link org.springframework.security.authentication.AuthenticationManager}的方式做权限认证
 * 自定义切入时机顺序：AuthenticationManager ---> AuthenticationProvider ---> UserDetailsService
 */
//@EnableWebSecurity
public class ICAuthenManagerConfig extends WebSecurityConfigurerAdapter {
    private static final Logger log = LoggerFactory.getLogger(ICAuthenManagerConfig.class);
